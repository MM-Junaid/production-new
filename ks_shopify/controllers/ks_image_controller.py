...
class KsShopifyCommerceImageUrl(Home):
    @http.route('/ks_shopify_image/<string:encoded_db>/<string:encoded_uid>/<string:encoded_image_id>/<string:image_name>',
        ...
        if encoded_db and encoded_uid and encoded_image_id:
            ...
            try:
                ...
                status, response_headers, content = request.env['ir.http'].sudo().binary_content(
                    model='ks.shopify.product.images', id=image_id,
                    field='ks_image')
