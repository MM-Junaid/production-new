...
class KsSaleReport(models.Model):
    ...
    ks_shopify_instance = fields.Many2one('ks.shopify.connector.instance', string='Shopify Instance', readonly=True, ondelete='cascade')
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause='', where_clause=''):
        ...
        where_ = """l.product_id IS NOT NULL AND s.ks_shopify_order_id IS NOT NULL AND s.ks_shopify_instance IS NOT NULL  %s""" % (
            where_clause)
